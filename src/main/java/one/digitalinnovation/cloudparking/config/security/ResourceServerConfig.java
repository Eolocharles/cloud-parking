...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    private static final String[] PUBLIC = { "/oauth/token", "/swagger/**", "/v2/api-docs", "/webjars/**", "/configuration/**", "/swagger-resources/**" };
    private static final String[] USER_OR_ADMIN = { "/api/v1/parking/**" };
